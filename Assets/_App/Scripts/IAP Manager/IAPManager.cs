...
public class IAPKey
{
    public const string PACK1 = "tele.merge.game.shop.pack1";
    public const string PACK2 = "tele.merge.game.shop.pack2";
    public const string PACK3 = "tele.merge.game.shop.pack3";
    public const string PACK4 = "tele.merge.game.shop.pack4";
    public const string PACK5 = "tele.merge.game.shop.pack5";
    public const string PACK6 = "tele.merge.game.shop.pack6";
}
